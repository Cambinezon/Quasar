...
public class Switch extends ContainerAction {
    ...
    public void render(int mouseX, int mouseY, float delta) {
        ...
        QR.drawString(title, getStartX()+4, getCenterY(), -1);
        QR.guiGraphics.setShaderColor((1f-process)*0.75f, process*0.75f, 0f, 1f);
        QR.drawTextureRect(Icons.SWITCHBG, getEndX()-20, getCenterY()-4, getEndX()-4, getCenterY()+4);
        QR.guiGraphics.setShaderColor(1f,1f,1f,1f);
        QR.drawTextureRect(Icons.SWITCHOUTLINE, getEndX()-20, getCenterY()-4, getEndX()-4, getCenterY()+4);
        QR.drawTextureRect(Icons.CIRCLE, getEndX()-12-8*(1f-process), getCenterY()-4, getEndX()-4-8*(1f-process), getCenterY()+4);
    }
