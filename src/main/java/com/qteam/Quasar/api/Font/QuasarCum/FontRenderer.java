...
import com.qteam.Quasar.api.Utils.ColorUtils;
import com.qteam.Quasar.api.Utils.MathUtils;
    ...
    public void drawInternal(MatrixStack stack, String s, float x, float y, float[] color, boolean shadow) {
        ...
        synchronized (GLYPH_PAGE_CACHE) {
            ...
            for (String textureKey : GLYPH_PAGE_CACHE.keySet()) {
                ...
                com.qteam.Quasar.api.Render.QRU.drawNoReset(bb.end());
            }

            GLYPH_PAGE_CACHE.clear();
        }
        stack.pop();
        com.qteam.Quasar.api.Render.QRU.resetShader();
    }
