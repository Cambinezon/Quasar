...
import static com.qteam.Quasar.api.FileSystem.JsonUtils.add;
...
//        }
//        try {
//            ConfigUtils.loadFromTxt("CurrentConfig", "Modules", Quasar::setCurrentConfigName);
//        } catch (IOException ignored) {}
//    }
//
...
//                jsonObject -> {
//                    try {
//                        saveConfigFile(Quasar.getCurrentConfigName());
//                    } catch (IOException e) {
//                        e.printStackTrace();
//                    }
//
...
//        ConfigUtils.loadFromTxt("Prefix", "", Quasar::setChatPrefix);
//    }
//
//    public static void savePrefix() throws IOException {
//        ConfigUtils.saveInTxt("Prefix", "", writer -> {
//            try {
//                writer.write(Quasar.getChatPrefix());
//            } catch (IOException ignored) {}
//        });
//    }
