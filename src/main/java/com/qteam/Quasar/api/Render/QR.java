package com.qteam.Quasar.api.Render;


import com.ferra13671.TextureUtils.PathMode;
import com.qteam.Quasar.api.FileSystem.ConfigSystem.ConfigUtils;
import com.qteam.Quasar.api.Font.QuasarCum.FontRenderManager;
import com.qteam.Quasar.api.Font.QuasarCum.FontUtils;
import com.qteam.Quasar.api.Other.RegionPos;
import com.qteam.Quasar.api.Render.Line.QuasarLineRender;
import com.qteam.Quasar.api.Render.Sphere.KappaSphereRender;
import com.qteam.Quasar.api.Render.Texture.Texture;
import com.qteam.Quasar.api.Utils.EntityUtils;
import com.qteam.Quasar.api.Utils.RotateUtils;
import com.qteam.Quasar.impl.Mc;
import com.qteam.Quasar.api.Render.Box.QuasarBoxRender;
...
public final class QR implements Mc {
    ...
    public static final QuasarLineRender lineRender = new QuasarLineRender();
    public static final QuasarBoxRender boxRender = new QuasarBoxRender();
    ...
    public static Font defualt = FontUtils.createFontNoThrow(ConfigUtils.newInputStream("assets/quasar/other/cubic.ttf", PathMode.INSIDEJAR), 17);
    ...
    public static void trace(Entity entity, MatrixStack matrixStack, float partialTicks, RegionPos region, Color color) {
        ...
        Vec3d start = RotateUtils.getClientLookVec(partialTicks)
                .add(QR.getCameraPos()).subtract(regionVec);
