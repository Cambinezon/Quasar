...
import com.lilyfena.NUBClient.api.MegaEvents.Base.EventBus;
import com.lilyfena.NUBClient.api.Shader.ShaderLoader;
...
public class DY implements ModInitializer, Mc {
    public static DY INSTANCE;
    public static String NAME = "Dyglet";
    ...
    public void loadShaders() {
        blurShader = new ShaderLoader(
                new Identifier("nubclient", "shaders/core/blur.vert"),
                new Identifier("nubclient", "shaders/core/blur.frag")
        ); blurShader.init();
    }
    ...
    public static void setCurrentConfigName(String currentConfigName) {
        DY.currentConfigName = currentConfigName;
    }
