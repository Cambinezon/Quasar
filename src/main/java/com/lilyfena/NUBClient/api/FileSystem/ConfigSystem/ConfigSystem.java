...
import static com.lilyfena.NUBClient.api.FileSystem.JsonUtils.add;
import static com.lilyfena.NUBClient.api.FileSystem.JsonUtils.equalsNull;
...
//        }
//        try {
//            ConfigUtils.loadFromTxt("CurrentConfig", "Modules", NUBClient::setCurrentConfigName);
//        } catch (IOException ignored) {}
//    }
//
...
//                add(jsonObject, "Bind", module.bind.getKey());
//                add(jsonObject, "Visible", module.isVisible.isEnabled());
//
...
//                    }
//                }
//                module.setQuietEnabled(jsonObject.get("Enabled").getAsBoolean());
//                int bind = jsonObject.get("Bind").getAsInt();
//                module.bind.setKey(bind);
//                module.setKey(bind);
//                module.isVisible.setEnabled(jsonObject.get("Visible").getAsBoolean());
//            });
//        }
//    }
...
//                add(moduleObject, "Bind", module.bind.getKey());
//                add(moduleObject, "Visible", module.isVisible.isEnabled());
//
//                if (!module.getSettings().isEmpty()) {
//                    for (Setting s : module.getSettings()) {
//                        s.save(settingObject);
...
//                jsonObject -> {
//                    try {
//                        saveConfigFile(NUBClient.getCurrentConfigName());
//                    } catch (IOException e) {
//                        e.printStackTrace();
//                    }
//
...
//                            module.isVisible.setEnabled(moduleObject.get("Visible").getAsBoolean());
//                        }
//                    }
//
//                    try {
...
//
//                add(frameObject, "x", frame.x);
//                add(frameObject, "y", frame.y);
//                add(frameObject, "opened", frame.extended);
//
//                add(jsonObject, frame.name, frameObject);
//            }
//        });
//    }
//
...
//            for (Frame frame : ClickGUI.getFrames()) {
//                JsonElement jsonElement = jsonObject.get(frame.name);
...
//
//                frame.x = (settingObject.get("x").getAsInt());
//                frame.y = (settingObject.get("y").getAsInt());
//                frame.extended = (settingObject.get("opened").getAsBoolean());
//            }
//        });
//    }
...
//        ConfigUtils.loadFromTxt("Prefix", "", NUBClient::setChatPrefix);
//    }
//
//    public static void savePrefix() throws IOException {
//        ConfigUtils.saveInTxt("Prefix", "", writer -> {
//            try {
//                writer.write(NUBClient.getChatPrefix());
//            } catch (IOException ignored) {}
//        });
//    }
