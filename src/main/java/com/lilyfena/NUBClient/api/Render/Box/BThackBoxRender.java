package com.lilyfena.NUBClient.api.Render.Box;
...
public final class BThackBoxRender {
    ...
    public void prepareBoxRender() {
        ...
        BTR.applyRegionalRenderOffset(BTR.worldRenderContext.matrixStack());
    ...
    public void renderBoxes(ArrayList<RenderBox> boxes) {
        MatrixStack matrixStack = BTR.worldRenderContext.matrixStack();
